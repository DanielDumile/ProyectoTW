                    ...
                    if (id_pregunta.equals(id)) {
                        if (tipo.equals("TrueFalse")) {
                            ...
                            out.println("<div id=\"TrueFalse\">\n"
                                    ...
                                    + "            \n"
                                    + "            \n"
                                    + "            <form v-on:submit=\"TF\" action=\"ModificarPregunta\" method=\"post\" enctype='multipart/form-data'>\n"
                                    + "                \n"
                            ...
                            out.println("<div id=\"Hot\">\n"
                                    ...
                                    + "            \n"
                                    + "            <form v-on:submit=\"Hot\" action=\"ModificarPregunta\" method=\"post\" enctype='multipart/form-data'>\n"
                                    + "                \n"
