 ...
 * @author USER
 */
public class BorrarExamen extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{//Se crea el documento a traves del archivo  
                ...
                out.println("<form method='post' name='f1' id='f1' action='EliminarExamen'>");
                    ...
                    out.println("<p class='Subtitulos'>Seleccione el examen que desee eliminar</p>");
                    out.println("<br />");
                    out.println("<hr />");
                    ...
                    out.print("<center><input type='button' value='Eliminar el examen seleccionado' class='button5' onclick='EliminarPregunta()' /></center>");
                    out.println("<br />");
